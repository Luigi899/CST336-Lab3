<?php
    ...
    function findGreater($sum1, $sum2, $sum3){
        $results_array = array();
        array_push($results_array, abs(42 - $sum1), abs(42 - $sum2), abs(42 - $sum3));
        ...
        if(duplicateCheck($sum1, $sum2, $sum3) == true){
            $minIndex = -1;
        }
    ...
    function duplicateCheck($sum1, $sum2, $sum3){
        $results_array = array();
        array_push($results_array, $sum1, $sum2, $sum3);
        for($i = 0; $i < 3; $i++){
            for($j = $i + 1; $j < 4; $j++)
